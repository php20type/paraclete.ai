									...
									<div class="row">								
										...
										<div class="col-lg-6 col-md-12 col-sm-12">							
											<div class="input-box">								
												...
												<div class="form-group">							    
													<input type="number" class="form-control" id="o1_preview" min=0 name="o1_preview" value="{{ $id->o1_preview_credits_prepaid }}">
													<span class="text-muted fs-10">{{ __('For AI Templates and AI Chat features') }}</span>
												</div> 
											</div> 						
										</div>
										...
										<div class="col-lg-6 col-md-12 col-sm-12">							
											<div class="input-box">								
												...
												<div class="form-group">							    
													<input type="number" class="form-control" id="o1_mini" min=0 name="o1_mini" value="{{ $id->o1_mini_credits_prepaid }}">
													<span class="text-muted fs-10">{{ __('For AI Templates and AI Chat features') }}</span>
												</div> 
											</div> 						
										</div>
										...
										<div class="col-lg-6 col-md-12 col-sm-12">							
											<div class="input-box">								
												...
												<div class="form-group">							    
													<input type="number" class="form-control" id="images" name="images" value="{{ $id->images }}">
