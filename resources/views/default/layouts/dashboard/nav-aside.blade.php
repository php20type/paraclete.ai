            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('#')}}">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ route('admin.settings.case') }}" class="slide-item">{{ __('Use Cases Section') }}</a></li>                                           
                        ...
                        <li><a href="{{ route('admin.settings.client') }}" class="slide-item">{{ __('Clients Section') }}</a></li>                      
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-md">
          <div class="modal-content">
            ...
            <div class="modal-body pl-5 pr-5">
                ...
                <hr class="mt-2 mb-2">
                <div class="d-flex justify-content-between">
                    <div class="text-muted fs-10">{{ __('OpenAI o1 Mini') }}</div>
                    <div class="text-muted fs-10">@if (\App\Services\HelperService::userAvailableO1MiniWords() == -1) {{ __('Unlimited') }} @else {{ App\Services\HelperService::userAvailableO1MiniWords()}} @endif {{ __('Words') }}</div>
                </div>
                <hr class="mt-2 mb-2">
                <div class="d-flex justify-content-between">
                    <div class="text-muted fs-10">{{ __('OpenAI o1 Preview') }}</div>
                    <div class="text-muted fs-10">@if (\App\Services\HelperService::userAvailableO1PreviewWords() == -1) {{ __('Unlimited') }} @else {{ App\Services\HelperService::userAvailableO1PreviewWords()}} @endif {{ __('Words') }}</div>
                </div>
                <hr class="mt-2 mb-2">
                <div class="d-flex justify-content-between">
                ...
                <hr class="mt-2 mb-2">
                <div class="d-flex justify-content-between">
                    <div class="text-muted fs-10">{{ __('Anthropic Claude 3.5 Haiku') }}</div>
